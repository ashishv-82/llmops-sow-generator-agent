...
def issue_detection_accuracy(
    detected_issues: list[dict[str, Any]], expected_issues: list[dict[str, Any]]
) -> dict[str, float]:
    """
    ...
    detected_set = {
        (issue.get("category", ""), issue.get("severity", "")) for issue in detected_issues
    }
...
def compare_to_baseline(
    current_results: dict[str, Any], baseline_results: dict[str, Any], threshold: float = 0.05
) -> dict[str, Any]:
    """
